...
import 'dart:async';
import 'package:lbwk/login.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Image.asset(
          'assets/logo.jpg', // Path gambar logo
          width: 200,
          height: 200,
        ),
      ),
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Padding(
            padding:
                const EdgeInsets.only(top: 40), // Memberikan jarak dari atas
            child: Center(
              child: Image.asset(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(
                      height: 40), // Spasi antara gambar biasa dan teks
